...
public class QualityController {
    ...
    @FXML private void openImage()   { /* stub: call model or service */ }
    @FXML private void deleteImage() { /* stub: call model or service */ }
    @FXML private void signOrder()   { /* stub: call model or service */ }
